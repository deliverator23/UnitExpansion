...
SELECT 'UNIT_DLV_CUIRASSIER', '4', '360', 'ADVISOR_CONQUEST', '2', 1, 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', 'LOC_UNIT_CUIRASSIER_NAME', 'LOC_UNIT_CUIRASSIER_DESCRIPTION', 'YIELD_GOLD', 'PROMOTION_CLASS_HEAVY_CAVALRY', '5', '66', 'RESOURCE_NITER', 'TECH_BALLISTICS', 'TECH_COMPOSITES'
WHERE NOT EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_CUIRASSIER');

INSERT INTO Units (UnitType, BaseMoves, Cost, AdvisorType, BaseSightRange, ZoneOfControl, Domain, FormationClass, Name, Description, PurchaseYield, PromotionClass, Maintenance, Combat, StrategicResource, PrereqTech, MandatoryObsoleteTech)
SELECT 'UNIT_DLV_MEDIEVAL_HORSEMAN', '4', '150', 'ADVISOR_CONQUEST', '2', 1, 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', 'LOC_UNIT_MEDIEVAL_HORSEMAN_NAME', 'LOC_UNIT_MEDIEVAL_HORSEMAN_DESCRIPTION', 'YIELD_GOLD', 'PROMOTION_CLASS_LIGHT_CAVALRY', '2', '44', 'RESOURCE_HORSES', 'TECH_STIRRUPS', 'TECH_COMPOSITES'
...
UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_DLV_COG' WHERE Unit = 'UNIT_PHOENICIAN_BIREME' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_PHOENICIAN_BIREME');

UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_DLV_RIFLEMAN' WHERE Unit = 'UNIT_OTTOMAN_JANISSARY' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_OTTOMAN_JANISSARY');